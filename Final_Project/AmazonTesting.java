...
public class AmazonTesting {
	...
	public static WebDriver driver=null;
		...
		public static void main(String[] args) throws InterruptedException{
			...
			String FilePath="C:\\Users\\MAYURI\\eclipse-workspace\\SeleniumProject\\src\\Final_Project\\";
			...
			try(PrintWriter writer = new PrintWriter(new FileWriter(new File(FilePath+CurrentTime.replaceAll(":", "-")+FileExtension)));
				BufferedReader reader = new BufferedReader(new FileReader(new File("C:\\Users\\MAYURI\\eclipse-workspace\\SeleniumProject\\src\\Final_Project\\ReadFile.txt")))){
				...
				if(itr.hasNext()) {
					...
					File src = new File("C:\\Users\\MAYURI\\eclipse-workspace\\SeleniumProject\\src\\Final_Project\\ReadProduct.xlsx");
